...
txnFixture = function(userCreatedAt, objCreatedAt){
  return __objectFixture("Txn", userCreatedAt, objCreatedAt)
}

ciFixture = function(userCreatedAt, objCreatedAt){
  return __objectFixture('CompanyImporter', userCreatedAt, objCreatedAt)
}
