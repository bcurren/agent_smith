...
function runSuite(){
  db.open(function(p_db){  
    db.collection('events', function(err, collection){
      collection.insert(
        [
          stubbedTxnEvent(daysAgo(20), daysAgo(1)),
          stubbedTxnEvent(daysAgo(15), daysAgo(1)),          
          stubbedTxnEvent(daysAgo(4), daysAgo(4)),
          stubbedTxnEvent(daysAgo(4), daysAgo(4)),
          stubbedTxnEvent(daysAgo(4), daysAgo(4)),
          stubbedTxnEvent(daysAgo(4), daysAgo(4)),          
          stubbedTxnEvent(daysAgo(3), daysAgo(3)),                    
          stubbedTxnEvent(daysAgo(3), daysAgo(3)),                    
          stubbedTxnEvent(daysAgo(3), daysAgo(3)),           
          stubbedTxnEvent(daysAgo(2), daysAgo(2)),                                                  
          stubbedTxnEvent(daysAgo(2), daysAgo(2)),                     
          stubbedTxnEvent(daysAgo(1), daysAgo(1)),               
          stubbedCiEvent(daysAgo(20), daysAgo(20)),                         
          stubbedCiEvent(daysAgo(20), daysAgo(20)),                                   
          stubbedCiEvent(daysAgo(21), daysAgo(1))                                   
        ], 
        function(err, ids){
