...
FISearchRetry = function() {
  ...
  this.__buildTable = function(results) {
    ...
    for (var i = 0; i < results.length; i++) {
      data += "<tr><td>" + results[i].original_query + "</td><td>" + results[i].count + "</td></tr>";
    }
    data += "</table>";
...
FISearchRetry.prototype.chartData = function(callback) {
  var self = this
